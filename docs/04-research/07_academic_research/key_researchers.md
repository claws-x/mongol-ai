...
digraph ResearcherNetwork {
    ...
    // 蒙古国研究者
    Boldbaatar [label="B. Chimed\n蒙古国立大学"];
    Tserenpurev [label="T. Myagmarsuren\n蒙古科大"];
    Ganbat [label="G. Tumennasan\n蒙古国立大学"];
    
    // 国际研究者
    Atwood [label="C. Atwood\n宾大"];
    Solonin [label="K. Solonin\n圣彼得堡"];
    
    // 合作边
    GaoWa -> Boldbaatar [label="MT"];
    GaoWa -> TieNiu [label="OCR"];
    TieNiu -> Tserenpurev [label="OCR"];
    Boldbaatar -> Ganbat [label="NLP"];
    Siqin -> Ganbat [label="Linguistics"];
    Atwood -> Solonin [label="Historical"];
}
```
