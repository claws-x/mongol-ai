...
class KnowledgeBaseTests(unittest.TestCase):
    ...
    def test_public_browser_uses_safe_dom_rendering(self):
        ...
        self.assertNotIn("mongolian_layout_engine.js", html)
        self.assertIn("../engine/index.html", html)
        self.assertIn("S2 语义引擎已启动", html)
        self.assertIn("截图只用于视觉回归", html)
        self.assertNotIn("未经正确输入序列、字体和截图复核", html)
        self.assertNotIn("ᠮᠣᠩᠭᠣᠯ ᠪᠢᠴᠢᠭ ᠦᠨ ᠲᠣᠭᠠᠴᠢᠯᠠᠯ", html)
